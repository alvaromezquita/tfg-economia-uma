...
\captionsetup[figure]{
  labelfont={it,12p}, % Fuente en cursiva y tamaño 12pt para "Figura X"
  textfont={it,12p},  % Fuente en cursiva y tamaño 12pt para el texto de la caption
}

\captionsetup[table]{
  labelfont={it,12p}, % Fuente en cursiva y tamaño 12pt para "Tabla X"
  textfont={it,12p},  % Fuente en cursiva y tamaño 12pt para el texto de la caption
} 
...
% Estilo para las subsubsecciones (en cursiva)
\titlecontents{subsubsection}
  [3em] % Espacio izquierdo
...
\noindent {\fontsize{16}{19.2}\selectfont \textbf{Declaración de originalidad y de visto bueno del tutor o tutora}} 
...
\noindent {\fontsize{16}{19.2}\selectfont \textbf{Título en inglés}} 
\addcontentsline{toc}{section}{Título en inglés} 
...
\addcontentsline{toc}{subsection}{Subepígrafe}


\subsubsection*{Subsubepígrafe} 
\addcontentsline{toc}{subsubsection}{Subsubepígrafe}

\begin{center}
    \centering
    \captionof{figure}{Logo de la facultad} % 
